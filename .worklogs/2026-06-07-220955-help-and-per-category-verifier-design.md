...
omittable, and all format docs move into `spec3 help` so the skill shrinks to a
pointer.
...
- Workflow gains: run `spec3 verify` before coding to confirm it fails in the
  right places (also surfaces missing verifier files).

## Key files for context

- `.plans/2026-06-07-202732-help-output-draft.md` — exact `spec3 help` text
