Summary
- Created the standalone `driftless` repository and added the preliminary plan.
...
Decisions made
- Put `driftless` in `/Users/tartakovsky/Projects/websmasher/spec3` instead of keeping it inside the fixture3 repository.
