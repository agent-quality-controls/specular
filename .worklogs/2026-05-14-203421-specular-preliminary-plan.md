Summary
- Created the standalone `specular` repository and added the preliminary plan.
...
Decisions made
- Put `specular` in `/Users/tartakovsky/Projects/websmasher/specular` instead of keeping it inside the fixture3 repository.
