Summary
- Updated the active specular plan to make guardrail3/shared AQC fact reuse a blocker before V1 checkers.
...
- Do not implement repository crawling, ignore handling, file reading semantics, config parsing, or source AST parsing inside specular checkers.
...
Next steps
- Decide whether specular depends directly on existing guardrail3 shared crates or first extracts them into AQC-neutral shared crates.
