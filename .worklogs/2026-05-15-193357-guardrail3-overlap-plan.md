Summary
- Updated the active spec3 plan to make guardrail3/shared AQC fact reuse a blocker before V1 checkers.
...
- Do not implement repository crawling, ignore handling, file reading semantics, config parsing, or source AST parsing inside spec3 checkers.
...
Next steps
- Decide whether spec3 depends directly on existing guardrail3 shared crates or first extracts them into AQC-neutral shared crates.
