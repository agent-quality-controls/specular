Summary
- Updated the `spec3` plans so the library boundary starts at the machine-readable spec.
- Removed prose plan, Markdown description, plan hash, and plan drift from the `spec3` runtime model.
...
- `.plans/2026-05-15-132431-spec3-validation-model-research.md`
